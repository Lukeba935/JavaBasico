 ...
 *
 */
public class TreinandoScanner2 {
	...
	public class TreinandoScanner {
		...
		public static void main(String[] args) {
			...
			**/
			...
			String controle = "C"; Scanner sc = new Scanner(System.in);
			while (controle.equals("C")) {
			System.out.print("Informe seu nome:");
			String nome = sc.nextLine(); System.out.print("Informe sua idade:");
			int idade = sc.nextInt(); System.out.print("Informe seu peso:");
